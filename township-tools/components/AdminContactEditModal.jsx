...
export default function AdminContactEditModal({ contact, onClose, onSaved }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-900 rounded-lg shadow-xl max-w-lg w-full p-6 my-auto"
      ...
      >
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <label className="block">
              <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">First name</span>
              <input
            ...
            <label className="block">
              <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Last name</span>
              <input
                className="w-full border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2 text-base text-gray-900 dark:text-gray-100"
          ...
          <label className="block">
            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Phone</span>
            <input
              type="tel"
              inputMode="numeric"
              maxLength={12}
          ...
          <div>
            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email status</span>
            <select
              value={selectValue}
              onChange={onStatusSelect}
              className="w-full border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2 text-base text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-900"
            >
            ...
            {statusMode === "other" && (
              <input
                ...
                className="mt-2 w-full border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2 text-base text-gray-900 dark:text-gray-100"
              />
            )}
          </div>
          ...
          {canEditAmo && (
            <label className="block">
              <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">AMO Individual ID</span>
              <input
                type="text"
                inputMode="numeric"
          ...
          <div className="border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/40/40 rounded-md p-3 space-y-2">
            <div className="flex items-center gap-1.5 text-xs font-semibold text-blue-900 dark:text-blue-200 uppercase tracking-wide">
              <MoveRight className="w-3.5 h-3.5" /> Township assignment
            </div>
            <p className="text-xs text-blue-900 dark:text-blue-200/80">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <label className="block">
                <span className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Region</span>
                <select
                  value={moveRegionId}
                  onChange={(e) => {
                  ...
                  className="w-full border border-gray-300 dark:border-gray-700 rounded-md px-2 py-1.5 text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
                >
              ...
              <label className="block">
                <span className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">County</span>
                <select
                  value={moveCountyId}
                  onChange={(e) => {
                  ...
                  disabled={!moveRegion}
                  className="w-full border border-gray-300 dark:border-gray-700 rounded-md px-2 py-1.5 text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 disabled:bg-gray-100 dark:disabled:bg-gray-800"
                >
              ...
              <label className="block">
                <span className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Township</span>
                <select
          ...
          <label className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-md mt-2 cursor-pointer">
            <input
              type="checkbox"
              className="mt-0.5"
          ...
          {error && (
            <div className="text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded-md px-3 py-2">
              {error}
            </div>
          )}
        </div>
        ...
        <div className="flex justify-end gap-2 mt-5 flex-wrap">
          <button
            onClick={() => !busy && onClose?.()}
            disabled={busy}
            className="text-sm font-medium text-gray-700 dark:text-gray-300 px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-950 disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            disabled={busy}
            className="flex items-center gap-1.5 text-sm font-semibold text-white bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-700 px-4 py-2 rounded-md disabled:opacity-50"
          >
