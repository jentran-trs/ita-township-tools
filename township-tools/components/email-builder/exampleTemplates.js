const EXAMPLE_TEMPLATES = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: 'ex-n-meeting-highlights',
        type: 'contentBody',
        data: {
          content: '<p><b>Board Meeting Highlights — February</b></p><ul><li>Approved 2026 annual budget of $4.8 million</li><li>Awarded road paving contract to Midwest Asphalt Corp.</li><li>Authorized purchase of new brush chipper for highway dept.</li><li>Scheduled public hearing on proposed zoning amendment (March 18)</li><li>Recognized Volunteer Firefighter Tom Harris for 20 years of service</li></ul>',
        },
        locked: false,
      },
      {
        ...
        type: 'contentBody',
        data: {
          content: '<p><b>Resident Resources</b></p><ul><li><a href="https://springfieldtwp.gov/assistance">Township Assistance Application</a></li><li><a href="https://springfieldtwp.gov/roads">Road Concern Report Form</a></li><li><a href="https://springfieldtwp.gov/volunteer">Fire Department Volunteer Application</a></li><li><a href="https://springfieldtwp.gov/meetings">Meeting Minutes &amp; Agendas</a></li><li><a href="https://springfieldtwp.gov/report">Annual Report 2025</a></li></ul>',
        },
        locked: false,
      },
      {
